...
const labelClass =
  "text-[11.5px] font-semibold text-text-2 tracking-[0.1px]";
    ...
    >
      ...
      <div className="flex flex-col gap-3.5">
          ...
          <div className="flex items-center justify-between text-[12px]">
            <label className="inline-flex items-center gap-[7px] text-text-2 cursor-pointer select-none">
              <input
                type="checkbox"
                defaultChecked
                className="w-3.5 h-3.5 m-0 accent-accent"
              />
              로그인 상태 유지
            </label>
        ...
        <div className="flex flex-col gap-2">
          ...
          >
            <span className="w-[22px] h-[22px] rounded-[5px] inline-flex items-center justify-center font-bold text-[13px] bg-white border border-border shrink-0" style={{ color: "#5f6368" }}>
              G
            </span>
